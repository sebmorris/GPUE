#------------vis.py---------------------------------------------------#
#
# Purpose: This file is used to generated density plots of the output 
#           in 2D using a SLURM job submission. The available cores
#           requested by the submission script will set up Python 
#           multiprocessing to allow multiple image generation. For a 
#           more up-to-date and faster script, use mpi_vis.py
#
#------------------------------------------------------------------------------#
